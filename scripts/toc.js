...
import {either, flags, lookAhead, lookBehind, namedCapture as tag, sequence, suffix} from 'compose-regexp'
...
const content = readFileSync(target, {encoding: 'utf-8'}).toString()
...
let inFence = false
let previousDepth = 0
const TOC = [...content.matchAll(titlesMatcher)]
...
writeFileSync(target, content.replace(tocMatcher, TOC), {encoding: 'utf-8'})
